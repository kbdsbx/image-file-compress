...
class Compress {
    ...
    transform ( args ) {
        ...
        var path = outer_canvas.toDataURL( this.options.output_type );
    ...
    merge ( args ) {
        ...
        if ( options.zoom ) {
            if ( options.max_width && ! options.max_height ) {
                ...
                args.height = args.img.height * (options.max_width / args.img.width);
            } else if ( ! options.max_width && options.max_height ) {
                args.width = args.img.width * ( options.max_height / args.img.height );
                args.height = options.max_height;
            } else {
                args.width = args.img.width;
                args.height = args.img.height;
